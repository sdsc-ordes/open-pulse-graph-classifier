...
uv pip install "neo4j==5.28.1" "typing-extensions==4.13.0" "sympy==1.13.1" "scipy==1.15.2"
...
# # Set compiler environment variables to use g++
# export CC=gcc
# export CXX=g++

#uv pip install --no-build-isolation "git+https://github.com/rusty1s/pytorch_sparse.git@0.6.18"
#uv pip install --no-build-isolation "git+https://github.com/rusty1s/pytorch_scatter.git@2.1.2"
